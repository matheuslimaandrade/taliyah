      ...
      <div className="py-24 px-96">
        <div className="py-16 h-80 box-border border-2 rounded-xl shadow-md">
          <div className="font-jakarta-bold flex items-center justify-center justify-evenly">
            <div>
              <img
                src="./src/assets/images/profilegithub.jpg"
                alt=""
            ...
            <div>
              <p className="text-lg">
                Hello<span className="text-red-600">,</span> <br />I
                <span className="text-red-600">'</span>m{" "}
                <span className="text-3xl font-bold">
                  Matheus Andrade<span className="text-red-600">.</span>
                </span>{" "}
                <br />I<span className="text-red-600">'</span>m a Web Developer{" "}
                <br /> <br /> <br />
            ...
            <div>
              <p className="text-lg">
                work <br />
                <span className="font-semibold">Freelancer Developer </span>
                <br /> <br />
                hobbies <br />
                <ul className="flex">
                  <li className="bg-orange-200 rounded-xl mr-2 px-2 text-sm text-red-800 font-semibold">
                    coding
                  </li>
                  <li className="bg-orange-200 rounded-xl mr-2 px-2 text-sm text-red-800 font-semibold">
                    movies
